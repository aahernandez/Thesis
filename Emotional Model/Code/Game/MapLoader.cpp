...
MapLoader::MapLoader(const ITCXMLNode& xmlNode)
{
...
void MapLoader::PopulateMap(Map *mapToPopulate)
{
	IXMLDomParser iDom;
...
void MapLoader::LoadKeys(const ITCXMLNode& xmlNode)
{
...
IntVector2 MapLoader::GetRotatedPosition(int numRotation, const IntVector2& position)
{
