...
class DaydreamBehavior : public Behavior
{
public:
	DaydreamBehavior();
	DaydreamBehavior(DaydreamBehavior *behaviorCopy);
	virtual ~DaydreamBehavior() override;
	...
	virtual DaydreamBehavior* Clone() override;
};